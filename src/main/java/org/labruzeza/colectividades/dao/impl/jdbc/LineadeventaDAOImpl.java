...
public class LineadeventaDAOImpl extends GenericDAO<Lineadeventa> implements LineadeventaDAO {
	...
	private final static String SQL_SELECT = 
		"select idLineaDeVenta, idVenta, idProducto, precio from lineadeventa where idLineaDeVenta = ?";

	private final static String SQL_INSERT = 
		"insert into lineadeventa ( idVenta, idProducto, precio ) values ( ?, ?, ? )";

	private final static String SQL_UPDATE = 
		"update lineadeventa set idVenta = ?, idProducto = ?, precio = ? where idLineaDeVenta = ?";
