/*
 * Created on 25 oct 2016 ( Time 00:14:38 )
...
public class ConfiguracionDAOImpl extends GenericDAO<Configuracion> implements ConfiguracionDAO {
	...
	private final static String SQL_SELECT = 
		"select idConfiguracion, nroCaja, fecha, tipoCaja from configuracion where idConfiguracion = ?";

	private final static String SQL_INSERT = 
		"insert into configuracion ( nroCaja, fecha, tipoCaja ) values ( ?, ?, ? )";

	private final static String SQL_UPDATE = 
		"update configuracion set nroCaja = ?, fecha = ?, tipoCaja = ? where idConfiguracion = ?";
